...
inline double CommonTimeToRosTime(::cartographer::common::Time time) {
    ...
    int64_t ns_since_unix_epoch =
            (uts_timestamp -
             ...
             10000000ll) *
            100ll;
    auto sec = static_cast<int64_t>(ns_since_unix_epoch / 1000000000);
    auto nanosec = ns_since_unix_epoch % 1000000000;
    double normal_time = sec * 1.0 + nanosec * 1e-9;
    return normal_time;
}
